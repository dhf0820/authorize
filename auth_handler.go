...
// 	log.Info("WriteLoginResponse:52")
...
// 		return forwarded
// 	}
// 	fmt.Printf("No Forwarding use remoteAddr: [%s]\n", r.RemoteAddr)
// 	//strings.SplitN(r.RemoteAddr),
// 	return r.RemoteAddr
// }
...
// 		if err != nil {
// 			errMsg := log.ErrMsg("Decode error:" + err.Error())
...
// 	log.Info(fmt.Sprintf("Actual Login took: %s", time.Since(startTime)))
// 	//fmt.Printf("\nUser:112 - %s\n", spew.Sdump(user))
// 	log.Info("JWToken: " + token)
// 	if err != nil {
// 		resp.Status = 400
// 		resp.Message = err.Error()
// 	} else {
...
// 	if err != nil {
// 		log.Warn("environment TOKENDURATION is invalid, defaulting to 15 Minutes")
// 		expMinutes = 15
// 		err = nil
// 	}
...
// 	WriteLoginResponse(w, &resp)
// 	log.Info(fmt.Sprintf("Login Elapsed time: %s\n", time.Since(StartTotalTime)))
// }
